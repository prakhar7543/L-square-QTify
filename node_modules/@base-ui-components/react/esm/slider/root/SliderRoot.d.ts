...
declare namespace SliderRoot {
    ...
    interface Props<Value extends number | readonly number[] = number | readonly number[]> extends Partial<Pick<useSliderRoot.Parameters, 'disabled' | 'max' | 'min' | 'minStepsBetweenValues' | 'name' | 'orientation' | 'largeStep' | 'step'>>, Omit<BaseUIComponentProps<'div', State>, 'onChange' | 'values'> {
        /**
