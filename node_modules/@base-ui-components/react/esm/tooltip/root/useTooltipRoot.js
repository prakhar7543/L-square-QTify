...
import { safePolygon, useClientPoint, useNextDelayGroup, useDismiss, useFloatingRootContext, useFocus, useHover, useInteractions } from '@floating-ui/react';
...
export function useTooltipRoot(params) {
  ...
  const {
    ...
    getFloatingProps: getPopupProps
  ...
  return React.useMemo(() => ({
    ...
    transitionStatus,
    onOpenChangeComplete
  }), [mounted, open, setMounted, positionerElement, setOpen, getTriggerProps, getPopupProps, context, instantType, transitionStatus, onOpenChangeComplete]);
}