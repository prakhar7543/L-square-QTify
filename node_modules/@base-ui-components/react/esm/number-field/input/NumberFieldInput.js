...
const NumberFieldInput = /*#__PURE__*/React.forwardRef(function NumberFieldInput(props, forwardedRef) {
  ...
  }, getInputValidationProps(getValidationProps(externalProps))), [getInputValidationProps, getValidationProps, id, required, name, disabled, readOnly, inputMode, inputValue, invalid, labelId, setFocused, setTouched, validationMode, formatOptionsRef, commitValidation, valueRef, setValue, getAllowedNonNumericKeys, getStepAmount, min, max, incrementValue, setInputValue, allowInputSyncRef, locale, handleInputRef]);
