...
export function useNumberFieldRoot(params) {
  ...
  return React.useMemo(() => ({
    ...
    locale,
    ...scrub
  }), [inputRef, mergedRef, inputValue, value, scrub, startAutoChange, stopAutoChange, minWithDefault, maxWithDefault, disabled, readOnly, id, setValue, incrementValue, getStepAmount, allowInputSyncRef, formatOptionsRef, valueRef, isPressedRef, intentionalTouchCheckTimeoutRef, movesAfterTouchRef, name, required, invalid, inputMode, getAllowedNonNumericKeys, min, max, setInputValue, locale]);
}