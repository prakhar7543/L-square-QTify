 ...
 * @public
 */
export declare function useRender<State extends Record<string, unknown>, RenderedElementType extends Element>(params: useRender.Parameters<State, RenderedElementType>): useRender.ReturnValue;
