...
var _useIOSKeyboardSlideFix = require("../../utils/useIOSKeyboardSlideFix");
...
function useDialogRoot(params) {
  ...
  const iOSKeyboardSlideFix = (0, _useIOSKeyboardSlideFix.useIOSKeyboardSlideFix)({
  ...
  const {
    getReferenceProps,
    getFloatingProps
  } = (0, _react2.useInteractions)([role, click, dismiss, iOSKeyboardSlideFix]);
  React.useEffect(() => {
