...
function usePopoverRoot(params) {
  ...
  return React.useMemo(() => ({
    ...
    openReason,
    onOpenChangeComplete
  }), [open, setOpen, mounted, setMounted, transitionStatus, positionerElement, titleId, descriptionId, getTriggerProps, getPopupProps, context, instantType, openMethod, openReason, onOpenChangeComplete]);
}