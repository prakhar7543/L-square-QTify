 ...
 */
const ScrollAreaContent = exports.ScrollAreaContent = /*#__PURE__*/React.forwardRef(function ScrollAreaContent(props, forwardedRef) {
  const {
    render,
    className,
    ...otherProps
  ...
  const {
    ...
    state,
    extraProps: (0, _mergeProps.mergeProps)(otherProps, {
      role: 'presentation',
      style: {
