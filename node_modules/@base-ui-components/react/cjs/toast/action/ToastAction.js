 ...
 */
const ToastAction = exports.ToastAction = /*#__PURE__*/React.forwardRef(function ToastAction(props, forwardedRef) {
  const {
    render,
    className,
    disabled,
  ...
  const {
    ...
    className,
    state,
    extraProps: (0, _mergeProps.mergeProps)(toast.actionProps, other, getButtonProps, {
...
process.env.NODE_ENV !== "production" ? ToastAction.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
