 ...
 */
const ToastTitle = exports.ToastTitle = /*#__PURE__*/React.forwardRef(function ToastTitle(props, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
process.env.NODE_ENV !== "production" ? ToastTitle.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
